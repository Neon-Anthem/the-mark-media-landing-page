  ...
  return (
    <Section>
      <div className="w-[90%] mx-auto">
        ...
        <div className="relative bg-radial-[at_25%_25%] from-primary to-brand-2 p-6">
          {/* Icon Cloud */}
          <div className="absolute top-12 sm:top-16 sm:bottom-16 bottom-12 right-12 sm:right-16 space-y-3 sm:space-y-5 *:text-secondary *:size-6 sm:*:size-8 *:stroke-[1.3px] rounded-[inherit]">
            <IconCoin />
            <IconChartDots2 />
          ...
          {/* Content */}
          <div className="w-full h-96 bg-background grid grid-rows-2 md:grid-rows-0 grid-cols-0 md:grid-cols-2 gap-2 *:p-2 md:*:p-4 xl:*:p-6 rounded-2xl">
            {/* Start */}
            <div className="space-y-4">
              <h3 className="text-2xl sm:text-6xl xl:text-7xl w-[70%] sm:w-full">
                Looking to grow your{" "}
                <span className="text-primary uppercase">marketing</span>{" "}
                returns?
              </h3>
              {/* CTA */}
              <CTAButton size={"small"}>Book a call</CTAButton>
              {/* End CTA */}
            </div>
            {/* End Start */}
