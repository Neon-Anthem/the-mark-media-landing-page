...
export default function AboutSection() {
  ...
  return (
    <Section
      className="px-2 sm:px-8 min-h-[150vh] bg-background text-foreground z-10!"
      ref={containerRef}
    >
      {/* Video Background */}
      ...
      <motion.div
        className="sticky top-1/2 mt-32 -translate-y-1/2 left-0 right-0 space-y-4 text-center sm:text-start"
        style={{
          opacity,
        }}
      >
